...
def Bike_control():
    ...
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.2,steer=-0.36))
    ...
    time.sleep(2)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.15,steer=-0.36))
    time.sleep(1)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.31,steer=-38))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.Brake |
                                                            carla.VehicleLightState.HighBeam))
    time.sleep(3)
    dropped_vehicle.set_light_state(carla.VehicleControl(hand_brake=True))
    print("Bike Parked")
...
try:
    ...
    car_model = get_blueprint_of_world.filter('yzf')[0]
